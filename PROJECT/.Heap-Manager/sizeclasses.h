...
#define TOTAL_BINS_IN_CLASS(no_of_pages,class_size)  (no_of_pages*SYS_PG_SZ)/(METABLOCK_SIZE+class_size)
...
void createSizeClassBinsList(mdb *,int ,int );

void createSizeClassPage(int ,int );

mdb getPageForAllocation(int );

int isSizeClassPageEmpty(int , int );

void removeEmptySizeClassPage(int , int );

extern int classSizeArray[NUM_OF_CLASSES];

static pageList page_list[MAX_PAGES];

extern pageList sizeClassList[NUM_OF_CLASSES][MAX_PAGES];
